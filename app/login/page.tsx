        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              ...
              <div className="bg-gray-50 px-3 py-2 rounded-md text-xs text-gray-600">
                <div className="font-medium">Mali İşler:</div>
                <div>finance@company.com / finance123</div>
              </div>
              <div className="bg-gray-50 px-3 py-2 rounded-md text-xs text-gray-600">
                <div className="font-medium">Akademisyen:</div>
                <div>prof.ozkan@university.edu.tr / prof12345</div>
              </div>
            </div>
          </div>
        </div>
