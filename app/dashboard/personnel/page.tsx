...
export default function PersonnelPage() {
  ...
  }, [personnel, debouncedSearch, statusFilter])
  ...
  return (
    <DashboardLayout user={user}>
      <div className="space-y-6">
        ...
        {/* Personnel Table with Virtual Scrolling */}
        <VirtualTable
          items={filteredPersonnel}
          height="calc(100vh - 400px)"
          estimatedRowHeight={72}
          getRowKey={(p) => p.id}
          emptyMessage={searchTerm || statusFilter ? 'Personel bulunamadı' : 'Henüz personel kaydı yok'}
          columns={[
            {
              key: 'personnel',
              header: 'Personel',
